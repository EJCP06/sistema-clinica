...
-- 1. Asegurar que tenemos los IDs correctos para los nombres solicitados
-- Primero, renombrar todos para no tener conflictos
...
-- Esto requiere saber qu? ten?an antes, pero podemos usar el nombre como referencia.
